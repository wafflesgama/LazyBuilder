...
namespace LazyProcedural
{
    public class ObjectFactory
    {
        ...
        public static Node CreateNode(ProcedureInfo procedureInfo)
        {

            Procedure procedure= (Procedure)Activator.CreateInstance(procedureInfo.Type);
            Node node = new Node(procedureInfo,procedure);
