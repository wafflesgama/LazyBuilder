        ...
        protected override void Run()
        {
            ...
            else if (_parameterResult.Value == "Intersection")
            {
                ...
                if (intersection != null)
                {
                    ...
                    superSurfaceEntity = new SurfaceEntity(numColumns, numRows, cellSize) {Origin = intersection.Min.ToVector2(), Material = (Material) groupingSurfaces.First().Material.DeepClone()};
                }
                else
                {
            ...
            else
            {
                ...
                //create the new surface that will enclose the information of all the previous ones
                superSurfaceEntity = new SurfaceEntity(numColumns, numRows, cellSize) {Origin = totalBoundingBox.Min.ToVector2(), Material = (Material) groupingSurfaces.First().Material.DeepClone()};
            }
