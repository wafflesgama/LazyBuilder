...
{
    public class ColorParameterInfo : PrimitiveParameterInfo<UnityEngine.Color>
    {
        public ColorParameterInfo(string label)
            : base(label)
        {
            FixedValue = UnityEngine.Color.white;
        ...
        public override string ValueLiteral
        {
            get
            {
                ...
                return "new UnityEngine.Color(" + fixedValue.R + "," + fixedValue.G + "," + fixedValue.B + "," + fixedValue.A + ")";
            }
        }



        /*public UnityEngine.Color FixedValue
        {
            get
            {
